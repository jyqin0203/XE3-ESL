...
const builds = [
  {
    ...
    output: 'assets/speakup/checkout/speakup-checkout-scene.glb',
    manifest: 'assets/speakup/checkout/checkout-build-manifest.json',
    hiddenMeshes: [
      'Checkout',
      'Checkout Eyes',
      'checkout-hand',
  ...
  },
  {
    ...
    output: 'assets/speakup/checkout/speakup-checkout-foreground.glb',
    manifest: 'assets/speakup/checkout/checkout-build-manifest.json',
    hiddenMeshes: [
      'Checkout',
      'Checkout Eyes',
  ...
  },
  {
    ...
    output: 'assets/speakup/shopapp/speakup-shopapp-high.glb',
    manifest: 'assets/speakup/shopapp/shopapp-build-manifest.json',
    hiddenMeshes: [
      'Woman and Horse',
      'Horse-eye',
      'Arm',
  ...
  },
  {
    ...
    output: 'assets/speakup/shopapp/speakup-shopapp-medium.glb',
    manifest: 'assets/speakup/shopapp/shopapp-build-manifest.json',
    hiddenMeshes: [
      'Woman and Horse',
      'Horse-eye',
