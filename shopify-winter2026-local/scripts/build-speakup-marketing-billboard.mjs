...
const outputDir = path.join(rootDir, 'assets/speakup/marketing');
...
const outputGlbPath = path.join(outputDir, 'speakup-marketing-scene.glb');
...
if (!overlaySourceNode || !overlaySourceMesh || !overlaySourcePrimitive) {
  throw new Error('Expected standalone Marketing billboard geometry.');
}
