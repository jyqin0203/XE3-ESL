...
const outputDir = path.join(rootDir, 'assets/speakup/retail');
...
const models = [
  {
    ...
    output: path.join(outputDir, 'speakup-retail-environment.glb'),
  ...
  },
  {
    ...
    output: path.join(outputDir, 'speakup-retail-hub.glb'),
  ...
  },
  {
    ...
    output: path.join(outputDir, 'speakup-retail-middle.glb'),
    removeAllMeshes: true,
  },
];
...
const manifest = {
  purpose: 'Remove Shopify retail merchandise while preserving the authored camera and timeline.',
  models: [],
};
